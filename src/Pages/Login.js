...
const Login=()=>{
    return(
        <div className=" bg-gray-800 block min-h-screen">
            <Navbar />
            <div className="w-full max-w-sm mx-auto overflow-hidden min-h-screen bg-white rounded-lg shadow-md dark:bg-gray-800">
