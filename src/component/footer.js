...
const Footer=()=>{
    return(
      ...
      <footer className="p-4 sm:p-6 bg-cyan-800 mt-8">
          <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                  <a href="https://flowbite.com/" className="flex items-center">
                    <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 mr-3" alt="Logo" />

                      <span className="self-center text-2xl font-semibold whitespace-nowrap text-yellow-300">IG</span>
                  </a>
              </div>
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      <h2 className="mb-6 text-sm font-semibold text-yellow-300 uppercase">Contacts</h2>
                      <ul className="text-yellow-100">
                          <li className="mb-4">
                              <p className="hover:underline">25078000000</p>
                          </li>
                      </ul>
                  </div>
                  <div>
                      <h2 className="mb-6 text-sm font-semibold  uppercase text-yellow-300">Address</h2>
                      <ul className="text-yellow-100">
                          <li className="mb-4">
                              <p className="hover:underline ">Kigali,Rwanda</p>
                          </li>
                          <li>
                              <p className="hover:underline">KCT FLOOR 10</p>
                          </li>
                      </ul>
                  </div>
              </div>
          </div>
          <hr className="my-6 sm:mx-auto border-yellow-100 lg:my-8" />
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-yellow-100 hover:text-yellow-300 ">© 2023 All Rights Reserved.
              </span>
