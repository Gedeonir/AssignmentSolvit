...
class Navbar extends Component{
    render(){
        return(
          ...
          <nav className="px-2 border-gray-200 bg-cyan-800 dark:border-gray-700">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
              ...
              <div className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-cyan-800 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-cyan-800 dark:bg-cyan-800 md:dark:bg-cyan-800 dark:border-gray-700">
                  <li>
                    <Link to='/home' className="block py-2 pl-3 pr-4 text-yellow-300 bg-cyan-800 rounded md:bg-transparent md:text-yellow-300 md:p-0 md:dark:text-yellow-300 dark:bg-blue-600 md:dark:bg-transparent" aria-current="page">Home</Link>
                  </li>                 
                  <li>
